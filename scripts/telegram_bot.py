...
class TelegramBot:
    ...
    def __init__(self, bot_token: Optional[str] = None, 
        ...
        if not self.bot_token:
            ...
            logger.info("Create bot via @BotFather and set: export TELEGRAM_BOT_TOKEN='your_token'")
    ...
    def send_price_alert(self, symbol: str, price: float, 
                        alert_type: str, trigger_price: float):
        """Send price alert."""
...
"""
    ...
    def send_order_alert(self, order_id: str, symbol: str, 
                        side: str, qty: int, status: str):
...
"""
    ...
    def send_margin_alert(self, available: float, used: float, 
...
"""
    ...
    def send_news_alert(self, headline: str, symbol: str, 
...
"""
    ...
    def send_announcement_alert(self, symbol: str, event_type: str, 
                               event_date: str, days_away: int):
...
"""
    ...
    def send_economic_alert(self, event_name: str, event_date: str, 
                           impact_level: str, days_away: int):
...
"""
    ...
    def send_gtt_trigger_alert(self, symbol: str, trigger_price: float, 
                              condition: str, order_type: str):
    ...
    def check_and_send_alerts(self):
        ...
        try:
            ...
            for row in cursor.fetchall():
                ...
                self.send_economic_alert(event_name, event_date, impact_level, days_away)
    ...
    def monitor_alerts(self, interval: int = 300, duration: Optional[int] = None):
        ...
        try:
            while True:
                ...
                print(f"✓ Checked at {datetime.now().strftime('%H:%M:%S')} - {alerts_sent} alerts sent")
...
def main():
    ...
    parser.add_argument('--get-chat-id', action='store_true',
                       help='Get your Telegram chat ID')
