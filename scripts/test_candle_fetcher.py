...
try:
    from candle_fetcher import get_access_token, fetch_candles, parse_candle, store_candles
    ...
    if raw_candles:
        ...
        # Parse and store
        parsed = [parse_candle(c, 'INFY', 'NSE_EQ|INE002A01018', '1d') for c in raw_candles]
