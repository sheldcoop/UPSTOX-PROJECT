...
class ErrorHandler:
    ...
    def log_error(self, error_type: str, error_message: str, 
        ...
        try:
            ...
            logger.error(f"{error_type}: {error_message} (Status: {status_code}, Endpoint: {endpoint})")
                ...
                try:
                    ...
                    if error_handler.rate_limit_reset_time:
                        if datetime.now() < error_handler.rate_limit_reset_time:
                            wait_time = (error_handler.rate_limit_reset_time - datetime.now()).total_seconds()
...
def main():
    ...
    parser.add_argument('--action', choices=['stats', 'test', 'clear'],
                       default='stats', help='Action to perform')
    parser.add_argument('--hours', type=int, default=24,
                       help='Hours to look back for statistics')
