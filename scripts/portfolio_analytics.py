...
class PortfolioAnalytics:
    ...
    def get_performance_summary(self, start_date: str, end_date: str) -> Dict:
        ...
        try:
            ...
            return {
                ...
                'total_pnl': equity_values[-1] - equity_values[0] if equity_values else 0,
                'sharpe_ratio': sharpe,
                ...
                'avg_daily_pnl': np.mean([e.get('pnl', 0) for e in equity_curve]) if equity_curve else 0
            }
    ...
    def _get_mock_equity_curve(self, start_date: str, end_date: str) -> List[Dict]:
        ...
        initial_capital = 100000
        daily_pnl = np.random.randn(len(dates)) * 500 + 200  # Avg +200/day with volatility
...
if __name__ == "__main__":
    ...
    print(f"  Max Drawdown: {summary.get('max_drawdown', {}).get('max_drawdown_percent', 0):.2f}%")
