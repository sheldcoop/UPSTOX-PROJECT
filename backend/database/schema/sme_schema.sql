-- Table C: SME Market Quote Data (Liquidity & Depth)
-- Stores 5-minute snapshots of SME stocks including Market Depth
-- Refined: Removed Circuit Limits, specific for SME analysis

CREATE TABLE IF NOT EXISTS market_quota_sme_data (
...
CREATE INDEX IF NOT EXISTS idx_sme_lookup 
ON market_quota_sme_data(instrument_key, timestamp DESC);
