-- Table D: NSE 500 Market Quote Data (Mainboard Liquidity)
-- Stores 5-minute snapshots of NSE 500 (Mainboard) stocks including Market Depth
-- Structure: Clone of market_quota_sme_data

CREATE TABLE IF NOT EXISTS market_quota_nse500_data (
    ...
    oi REAL,               -- Open Interest (if applicable)
...
CREATE INDEX IF NOT EXISTS idx_nse500_lookup 
ON market_quota_nse500_data(instrument_key, timestamp DESC);
