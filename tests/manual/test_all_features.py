...
def main():
    ...
    print(
        f"{BLUE}║                  UPSTOX BACKEND - FEATURE TEST SUITE                  ║{RESET}"
    )
    print(
        f"{BLUE}╚═══════════════════════════════════════════════════════════════════════╝{RESET}"
    )
    ...
    print("\n" + "=" * 80)
    print(
        f"Total: {total_tests} | Passed: {GREEN}{passed_tests}{RESET} | Failed: {RED}{failed_tests}{RESET}"
    )
    print("=" * 80)
